...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EducaImpacto — Educação inovadora e baseada em evidências" },
      { name: "description", content: "Soluções gamificadas, conteúdos multimodais e formação docente para transformar a educação básica brasileira." },
      { property: "og:title", content: "EducaImpacto — Educação inovadora e baseada em evidências" },
      { property: "og:description", content: "Tecnologia, pedagogia e impacto social a serviço da educação básica." },
